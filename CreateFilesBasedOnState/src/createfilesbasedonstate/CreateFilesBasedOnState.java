package createfilesbasedonstate;
...
public class CreateFilesBasedOnState {
    ...
    public static void main(String[] args) {
        ...
        Path inStateFile = Paths.get("E:\\testFiles\\inStateFile.txt");
        Path outOfStateFile = Paths.get("E:\\testFiles\\outOfStateFile.txt");
        ...
        (outOfStateFile, CREATE, WRITE);
            ...
            while(!(idString.equals(QUIT))){
                ...
                System.out.print("Enter name for the customer: ");
                name = input.nextLine();
                ...
                System.out.print("Enter next customer's account number or "+QUIT+
                        " to quit:");
                idString = input.nextLine();
            }
            fcIn.close();
