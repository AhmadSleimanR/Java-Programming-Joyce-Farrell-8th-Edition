...
public class Main {
    ...
    public static StringBuilder displayWin(char[][] xos, boolean player){
        ...
        for(a = 0;a < 3;++a){
            for(b = 0;b < 3;++b){
                if(Character.isDigit(xosDup[a][b]))
                    win.append('-').append(" ");
                else
                    win.append(xosDup[a][b]).append(" ");
            }
            win.append("\n");
        }
        return win;
    ...
    public static StringBuilder display(char[][] xos){
        ...
        for(a = 0;a < 3;++a){
            for(b = 0;b < 3;++b){
                if(Character.isDigit(xosDup[a][b]))
                    playPos.append('-').append(" ");
                else
                    playPos.append(xosDup[a][b]).append(" ");
            }
            playPos.append("\n");
        }
        return playPos;
    ...
    public static boolean calculate(char[][] xos, boolean player){
        if((xos[0][0] == xos[0][1] && xos[0][0] == xos[0][2])
                                ||
            (xos[1][0] == xos[1][1] && xos[1][0] == xos[1][2])
                                ||
            (xos[2][0] == xos[2][1] && xos[2][0] == xos[2][2])
                                ||
            (xos[0][0] == xos[1][1] && xos[0][0] == xos[2][2])
                                ||
            (xos[0][2] == xos[1][1]&& xos[0][2] == xos[2][0])
                                ||
            (xos[0][0] == xos[1][0] && xos[0][0] == xos[2][0])
                                ||
            (xos[0][1] == xos[1][1] && xos[0][1] == xos[2][1])
                )
                return true;
